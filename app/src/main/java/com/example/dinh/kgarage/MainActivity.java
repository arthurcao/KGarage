...
import com.example.dinh.kgarage.MyGarage.SlidingTabLayout;
import com.example.dinh.kgarage.MyGarage.ViewPagerFragment;
import com.example.dinh.kgarage.fragment.AuthorizationsFragment;
import com.example.dinh.kgarage.fragment.LoginFragment;
import com.example.dinh.kgarage.fragment.RequestsFragment;
import com.example.dinh.kgarage.object.ItemAuthorizations;
import com.example.dinh.kgarage.object.ItemRequest;
import com.example.dinh.kgarage.utils.HttpPostToServer;
import com.example.dinh.kgarage.utils.HttpRequestData;
import com.example.dinh.kgarage.utils.HttpRequestListener;
...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener, HttpRequestListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            PackageInfo info = getPackageManager().getPackageInfo("com.example.dinh.kgarage", PackageManager.GET_SIGNATURES);
...
//        }
        ...
        switch (position) {
            case 0:
                ...
                fragmentManager.beginTransaction().replace(R.id.container, mViewPagerFragment)
                        .commit();
            ...
            case 1:
                ...
                fragmentManager.beginTransaction()
                        .replace(R.id.container, RequestsFragment.newInstance(position + 1))
                        .commit();
                break;
            case 2:
                ...
                fragmentManager.beginTransaction()
                        .replace(R.id.container, AuthorizationsFragment.newInstance(position + 1))
                        .commit();
                break;
            case 3:
...
//                }
            ...
            default: {
                ...
                fragmentManager.beginTransaction()
                        .replace(R.id.container, mViewPagerFragment)
                        .commit();
            }
...
//
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (mCurrentFagment == FRAGMENT_DOOR) {
            ...
            menu.findItem(R.id.menu_main_set).setVisible(false);
