...
import com.example.dinh.kgarage.utils.DatePickerFragment;
import com.example.dinh.kgarage.utils.TimePickerFragment;
...
public class SetTimeAuthorizationsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatePickerFrom = (DatePicker) findViewById(R.id.set_time_from_datePicker);
        mTimePickerFrom = (TimePicker) findViewById(R.id.set_time_from_timePicker);
        mDatePickerTo = (DatePicker) findViewById(R.id.set_time_to_datePicker);
        mTimePickerTo = (TimePicker) findViewById(R.id.set_time_to_timePicker);

        mAuthNotify = (CheckBox) findViewById(R.id.set_time_auth_notify);
        mNotify = (CheckBox) findViewById(R.id.set_time_notify);
        mForever = (CheckBox) findViewById(R.id.set_time_forever);
