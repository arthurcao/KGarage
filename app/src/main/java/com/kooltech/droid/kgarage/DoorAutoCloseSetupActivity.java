...
import com.kooltech.droid.kgarage.segment.SegmentedGroup;
...
public class DoorAutoCloseSetupActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSwitchEnable = (Switch) findViewById(com.kooltech.droid.kgarage.R.id.auto_close_activity_enable);
        mSwitchTime = (Switch) findViewById(com.kooltech.droid.kgarage.R.id.auto_close_time_window);

        mDurationText = (TextView) findViewById(com.kooltech.droid.kgarage.R.id.auto_close_activity_duration_text);
        mSwitchEnable = (Switch) findViewById(com.kooltech.droid.kgarage.R.id.auto_close_activity_enable);
        mTimePickerFrom = (TimePicker) findViewById(com.kooltech.droid.kgarage.R.id.auto_close_activity_from_timePicker);
        mTimePickerTo = (TimePicker) findViewById(com.kooltech.droid.kgarage.R.id.auto_close_activity_to_timePicker);
        mDuarationPicker = (NumberPicker) findViewById(com.kooltech.droid.kgarage.R.id.auto_close_activity_durationspicker);
...
//        06-10 10:23:28.521  29924-29924/com.kooltech.droid.kgarage E/20150525? load mItemDoor.door_auto_end: 23:59:5
        isCustom = true;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case android.R.id.home:
                finish();
                break;
            case com.kooltech.droid.kgarage.R.id.menu_auto_cloase_add:
                sendHtp("0");
                break;
            default:
                break;
